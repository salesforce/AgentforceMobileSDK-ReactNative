...
# Android wrapper script - exports REACT_NATIVE_BOOST_PATH from local.properties
# Usage: This script is called by npm scripts (android:service, android:employee, etc.)
...
# Pass through all arguments to react-native CLI
