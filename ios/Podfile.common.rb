...
def shared_pods
  ...
  # AgentforceSDK depends on ('SharedUI', '~> 1'). Pin to the
  ...
  # Pin to 2.11.0, which satisfies Messaging-Multimedia-Core 1.12.0's
  # `~> 2.11.0` requirement and prevents CocoaPods from selecting an incompatible
  # LiveKit/WebRTC pair from a newer minor line.
